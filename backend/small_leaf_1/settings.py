"""
Django settings for small_leaf_1 project.
...
ROOT_URLCONF = 'small_leaf_1.urls'
...
WSGI_APPLICATION = 'small_leaf_1.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "small_leaf_1 API",
    "DESCRIPTION": "API documentation for small_leaf_1 App",
    "VERSION": "v1",
}
